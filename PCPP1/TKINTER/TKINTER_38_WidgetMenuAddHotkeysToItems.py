"""
Add hot keys to menu items

We’ve made two changes – we’ve added two underlined property specifications to
the Menu() invocations:
...
NOTE: The underlines do not appear until you hit Alt
