"""
Adding an item (or items) to the newly added cascade requires some steps you
already know – look, we’ve engaged the for loop to simulate the presence of
eight recently opened files
"""
